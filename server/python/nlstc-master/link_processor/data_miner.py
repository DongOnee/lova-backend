...
class LinkMiner:
    ...
    def request_creator(self):
        ...
        hdr = {'User-Agent':'Mozilla/5.0 (X11; U; Linux i686; en-US; rv:1.9.0.3) Gecko/2008092416 Firefox/3.0.3'}
        #dr = {'User-Agent': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_4) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.131 Safari/537.36'}
    ...
    def link_searching(self):
        ...
        #print(html_data)
        # parse url
        get_details = html_data.find_all("div", class_='g')
        result = []
